    ...
    <div class="fade-in">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header"><strong>Edit Blog</strong>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('title') is-invalid @enderror" placeholder="Enter Title" name="title" id="title" type="text" value="{{$blog->title}}" required>
                                        @error('title')
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" placeholder="Enter Description" class="description form-control @error('description') is-invalid @enderror">{{ $blog->description }}</textarea>
                                        @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
